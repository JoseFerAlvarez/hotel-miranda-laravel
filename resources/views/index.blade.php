...
<body>
    ...
    @section('index-content')
        ...
        <section class="about-data">
            ...
            <div class="about-data__card__container">
                <div class="about-data__card about-data__card__team">
                    <img class="about-data__card__img" src="{{ asset('assets/images/wine.jpg') }}">
                    <div class="about-data__card__description">
                        <img class="about-data__card__description__img" src="{{ asset('assets/icons/team.svg') }}">
                        ...
                        <img class="about-data__card__description__background" src="{{ asset('assets/icons/team.svg') }}">
                    </div>
                </div>

                <div class="about-data__card about-data__card__room">
                    <img class="about-data__card__img" src="{{ asset('assets/images/luxury-room.jpg') }}">
                    <div class="about-data__card__description about-data__card__description--dark">
                        <img class="about-data__card__description__img" src="{{ asset('assets/icons/calendar.svg') }}">
                        ...
                        <div class="swiper-slide">
                            <div class="room">
                                <div class="room__container">
                                    ...
                                    @endif
                                    <div class="room__img" style="background-image: url('{{ url($room->photo) }}')">
                                    </div>
                                </div>
                                <div class="room__data">
                                    <div class="room__data__text">
                                        <p class="room__data__text__title">{{ $room->typeroom }}</p>
                                        <p class="text-roboto text-roboto--grey room__data__text__description">
                                            {{ $room->cancellation }}</p>
                                    </div>
                                    <div class="room__data__properties">
                                        <p class="room__data__properties__price">${{ $room->price / 100 }}<span
            ...
            <div class="home-video__container">
                ...
                <div class="home-video__source">
                    <video class="home-video__video" controls>
                        <source src="{{ asset('assets/videos/luxury-hotel.mp4') }}" type="video/mp4">
                    </video>
                </div>
        ...
        <section class="core-features">
            ...
            <div class="swiper-feature">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="feature">
                            <img class="feature__img-foreground" src="{{ asset('assets/images/rating.png') }}">
                    ...
                    <div class="swiper-slide">
                        <div class="feature">
                            <img class="feature__img-foreground" src="{{ asset('assets/images/clock.png') }}">
                    ...
                    <div class="swiper-slide">
                        <div class="feature">
                            <img class="feature__img-foreground" src="{{ asset('assets/icons/location.svg') }}">
                    ...
                    <div class="swiper-slide">
                        <div class="feature">
                            <img class="feature__img-foreground" src="{{ asset('assets/images/clock-cancel.png') }}">
                    ...
                    <div class="swiper-slide">
                        <div class="feature">
                            <img class="feature__img-foreground" src="{{ asset('assets/icons/payment.svg') }}">
                    ...
                    <div class="swiper-slide">
                        <div class="feature">
                            <img class="feature__img-foreground" src="{{ asset('assets/icons/offer.svg') }}">
        ...
        <section class="foods-menu">
            ...
            <img class="foods-menu__img" src="{{ asset('assets/images/donut.png') }}">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="swiper-food__column">
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/eggs-bacon.jpg') }}')">
                                </div>
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/coffe.jpg') }}')">
                                </div>
                                <div class="food__text">
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/chia.jpg') }}')">
                                </div>
                                <div class="food__text">
                    ...
                    <div class="swiper-slide">
                        <div class="swiper-food__column">
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/fruit.jpg') }}')">
                                </div>
                                <div class="food__text">
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/marmalade.jpg') }}')">
                                </div>
                                <div class="food__text">
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/cheese.jpg') }}')">
                                </div>
                                <div class="food__text">
                    ...
                    <div class="swiper-slide">
                        <div class="swiper-food__column">
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/spaguetti.jpg') }}')">
                                </div>
                                <div class="food__text">
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/paella.jpg') }}')">
                                </div>
                                <div class="food__text">
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/gazpacho.jpg') }}')">
                                </div>
                                <div class="food__text">
                    ...
                    <div class="swiper-slide">
                        <div class="swiper-food__column">
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/sandwich.jpg') }}')">
                                </div>
                                <div class="food__text">
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/morteruelo.jpg') }}')">
                                </div>
                                <div class="food__text">
                            ...
                            <div class="food">
                                <div class="food__img"
                                    style="background-image: url('{{ asset('assets/images/arepa.jpg') }}')">
                                </div>
                                <div class="food__text">
            ...
            <div class="food-list__img">
                <div class="food-list__img__img"
                    style="background-image: url('{{ asset('assets/images/paella.jpg') }}')"></div>
                <div class="food-list__img__img"
                    style="background-image: url('{{ asset('assets/images/morteruelo.jpg') }}')">
                </div>
                <div class="food-list__img__img"
        ...
        <section class="statistics">
            <div class="statistics__stat">
                <img class="statistics__stat__img" src="{{ asset('assets/images/rocket.png') }}">
            ...
            <div class="statistics__stat">
                <img class="statistics__stat__img" src="{{ asset('assets/images/users.png') }}">
            ...
            <div class="statistics__stat">
                <img class="statistics__stat__img" src="{{ asset('assets/images/stats.png') }}">
            ...
            <div class="statistics__stat">
                <img class="statistics__stat__img" src="{{ asset('assets/images/book.png') }}">
