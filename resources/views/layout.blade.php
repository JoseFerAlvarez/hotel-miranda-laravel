            ...
            <div class="topbar__container">
                <div class="topbar__container__images">
                    ...
                    <div class="logo">
                        ...
                        <img class="logo__wordmark" src="{{ asset('assets/icons/wordmark.svg') }}">
                    </div>
                </div>
            ...
            <div class="footer__content">
                <div class="footer__description">
                    <div class="logo logo--golden">
                        ...
                        <img class="logo--golden__wordmark" src="{{ asset('assets/icons/wordmark.svg') }}">
                    </div>
                    ...
                    <div class="footer__description__social-media">
                        <a href="#" class="social-media-link"><img class="social-media-link__icon"
                                src="{{ asset('assets/icons/facebook.svg') }}"></a>
                        <a href="#" class="social-media-link"><img class="social-media-link__icon"
                                src="{{ asset('assets/icons/twitter.svg') }}"></a>
                        <a href="#" class="social-media-link"><img class="social-media-link__icon"
                                src="{{ asset('assets/icons/behance.svg') }}"></a>
                        <a href="#" class="social-media-link"><img class="social-media-link__icon"
                                src="{{ asset('assets/icons/linkedin.svg') }}"></a>
                        <a href="#" class="social-media-link"><img class="social-media-link__icon"
                                src="{{ asset('assets/icons/youtube.svg') }}"></a>
                    </div>
                </div>
                ...
                <div class="footer__contact">
                    ...
                    <div class="footer__contact__container">
                        <img class="footer__contact__img" src="{{ asset('assets/icons/phone.svg') }}">
                    ...
                    <div class="footer__contact__container">
                        <img class="footer__contact__img" src="{{ asset('assets/images/hotel-address.png') }}">
                        <div class="footer__contact__data">
                            <p class="footer__contact__data__title">Phone number</p>
                            <p class="footer__contact__data__text">+987 876 765 76 577</p>
                        </div>
                    ...
                    <div class="footer__contact__container">
                        <img class="footer__contact__img" src="{{ asset('assets/images/email.png') }}">
                        <div class="footer__contact__data">
                            <p class="footer__contact__data__title">Phone number</p>
                            <p class="footer__contact__data__text">+987 876 765 76 577</p>
                        </div>
