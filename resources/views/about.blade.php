        ...
        <section class="about-us__description">
            ...
            <div class="about-us__description__advantages">
                <div class="about-us__description__advantage">
                    <img class="about-us__description__advantage__img" src="{{ asset('assets/images/breakfast.png') }}">
                ...
                <div class="about-us__description__advantage">
                    <img class="about-us__description__advantage__img about-us__description__advantage__img__plane"
                        src="{{ asset('assets/images/plane.png') }}">
                    <p class="about-us__description__advantage__text">AIRPORT PICKUP</p>
                </div>

                <div class="about-us__description__advantage">
                    <img class="about-us__description__advantage__img" src="{{ asset('assets/icons/city-location.svg') }}">
                ...
                <div class="about-us__description__advantage about-us__description__advantage__barbecue">
                    <img class="about-us__description__advantage__img" src="{{ asset('assets/images/barbecue.png') }}">
                    <p class="about-us__description__advantage__text">BBQ PARTY</p>
                </div>

                <div class="about-us__description__advantage">
                    <img class="about-us__description__advantage__img" src="{{ asset('assets/icons/room.svg') }}">
            ...
            <div class="restaurant">
                <div class="restaurant__img__container">
                    <img class="restaurant__img" src="{{ asset('assets/images/restaurant.jpg') }}">
                </div>
        ...
        <section class="about-us__counter">
            ...
            <div class="about-us__counter__feature__container">
                <div class="about-us__counter__feature">
                    <img class="about-us__counter__feature__img" src="{{ asset('assets/icons/likes.svg') }}">
                    ...
                    <img class="about-us__counter__feature__arrow" src="{{ asset('assets/icons/arrow.svg') }}">
                </div>
                <div class="about-us__counter__feature">
                    <img class="about-us__counter__feature__img" src="{{ asset('assets/icons/reviews.svg') }}">
                    <div class="about-us__counter__feature__fact">
                ...
                <div class="about-us__counter__feature">
                    <img class="about-us__counter__feature__img" src="{{ asset('assets/icons/coverage.svg') }}">
                    <div class="about-us__counter__feature__fact">
            ...
            <div class="swiper-counter">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="{{ asset('assets/images/feature1.jpg') }}">
                    </div>
                    <div class="swiper-slide">
                        <img src="{{ asset('assets/images/feature2.jpg') }}">
                    </div>
                    <div class="swiper-slide">
                        <img src="{{ asset('assets/images/feature3.jpg') }}">
                    </div>
                </div>
